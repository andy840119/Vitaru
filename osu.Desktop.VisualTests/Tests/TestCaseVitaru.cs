...
{
    internal class TestCaseVitaru : TestCase
    {
        protected Player Player;
        private BeatmapDatabase db;


        public override string Description => @"Showing everything to play Vitaru";
        ...
        public override void Reset()
        {
            ...
            var beatmapInfo = db.Query<BeatmapInfo>().FirstOrDefault(b => b.Mode == PlayMode.Vitaru);
            if (beatmapInfo != null)
